    ...
    <Card>
      ...
      <Form :model="formLogistics" label-position="right" :label-width="100">
        ...
        <Row>
          <i-col span="8">
            <FormItem label="发货地：">
              <TejCascader :data="addressCascader" @cascader-callback="cascaderCallback"/>
...
<script>
  ...
  import {postAddExpressage} from '@/api/api'
  import LogisticsPrice from './components/LogisticsPrice'

  export default {
    name: 'AddLogistics',
    components: {TejCascader, Area, LogisticsPrice},
    props: {},
    data() {
      return {
        addressCascader: [],
