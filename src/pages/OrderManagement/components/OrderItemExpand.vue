<template>
  <div class="tej-order-item-expand">
    ...
    <div class="right">
      ...
      <p><span class="label">总计：</span><span>{{row.orderProductPrice | money}}元</span></p>
    </div>
  </div>
</template>
...
<style>
  ...
  .tej-order-item-expand {
    display: table;
    width: 100%;
  }
  .tej-order-item-expand .left{
    display: table-cell;
    width: 80%;
    border-right: 1px solid #e8eaec;
  }
  .tej-order-item-expand .right{
    display: table-cell;
    width: 20%;
    vertical-align: middle;
  }
  .tej-order-item-expand .right .label {
